...
if (idade >= 18) {
    console.log("Seja bem-vindo! você tem a idade nescessária e teve acesso ao site!")
} else {
...
let numero = prompt("Me fale um número:")
...
let nota = prompt("Digite um Número:")
...
let numeroInteiro = parseInt(Math.random() * 10);
    console.log("O Número aleatório gerado foi:" + numeroInteiro);


// Use o Math.random para gerar um número inteiro entre 1 e 1000 e exiba esse número no console.

let numeroMil = parseInt(Math.random() * 1000);
    console.log("O Número aleatório entre 1 e 1000 é: " + numeroMil + "!");
